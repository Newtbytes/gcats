...
| ------------- | ------------- | ------------- |
|  Interdimensional Map Markers | Makes maps show your location even when in other dimensions. | [https://modrinth.com/project/oiCuHwqj](https://modrinth.com/project/oiCuHwqj) |
| Alternate Current | An efficient and non-locational redstone dust implementation | [https://modrinth.com/project/r0v8vy1s](https://modrinth.com/project/r0v8vy1s) |
| Amplified Nether | The nether explorer's simple dream: doubled height and amplified terrain. What more is needed? | [https://modrinth.com/project/wXiGiyGX](https://modrinth.com/project/wXiGiyGX) |
...
| Snow Under Trees (Fabric) | Adds snow under trees in snowy biomes, making the biomes more immersive. | [https://modrinth.com/project/XVnUIUAQ](https://modrinth.com/project/XVnUIUAQ) |
| Structure Layout Optimizer | Attempts to optimize the generation of Jigsaw Structures and NBT pieces | [https://modrinth.com/project/ayPU0OHc](https://modrinth.com/project/ayPU0OHc) |
| Styled Chat | Style your server's chat as you want! | [https://modrinth.com/project/doqSKB0e](https://modrinth.com/project/doqSKB0e) |
...
| ImmediatelyFast | Speed up immediate mode rendering in Minecraft | [https://modrinth.com/project/5ZwdcRci](https://modrinth.com/project/5ZwdcRci) |
| More Culling | A mod that changes how multiple types of culling are handled in order to improve performance | [https://modrinth.com/project/51shyZVL](https://modrinth.com/project/51shyZVL) |
| Sodium | The fastest and most compatible rendering optimization mod for Minecraft. Now available for both NeoForge and Fabric! | [https://modrinth.com/project/AANobbMI](https://modrinth.com/project/AANobbMI) |

### Both

| Name | Description | URL |
| ------------- | ------------- | ------------- |
| Balm | Abstraction Layer for Multi-Loader Mods | [https://modrinth.com/project/MBAkmtvl](https://modrinth.com/project/MBAkmtvl) |
| Cloth Config API | Configuration Library for Minecraft Mods | [https://modrinth.com/project/9s6osm5g](https://modrinth.com/project/9s6osm5g) |
| Cobweb | Crystal Nest API | [https://modrinth.com/project/dQcfqGbl](https://modrinth.com/project/dQcfqGbl) |
| Collective | 🎓 Collective is a shared library with common code for all of Serilum's mods. | [https://modrinth.com/project/e0M1UDsY](https://modrinth.com/project/e0M1UDsY) |
